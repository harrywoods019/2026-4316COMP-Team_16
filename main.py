...
def run_hamzah():
    ...
    for season in df["Season"].unique():
        ...
        for team in all_teams:
            ...
            cards = (
                home["HomeTeamYellowCards"].sum() +
                away["AwayTeamYellowCards"].sum() +
                home["HomeTeamRedCards"].sum() * 2 +
                away["AwayTeamRedCards"].sum() * 2
            )
...
def main_menu():
    while True:
        print("\n" + "=" * 50)
        print("4316COMP Team 16 - Premier League Data Analysis")
        print("=" * 50)
        print("1. Alan - Home Advantage")
        print("2. Harry - Betting Odds Prediction Accuracy")
        print("3. Hamzah - Cards vs Points")
        print("4. Matthew - Home/Away Goals and Draws")
        print("5. Dylan - Shots/Goals and Fouls/Points")
        print("6. Tom - Match Competitiveness and Result Trends")
        print("7. Run All Visualisations")
        print("8. Exit")
